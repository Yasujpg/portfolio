import Bruver from "../assets/bruver.png"
        ...
        <div className="featured-project">         
          <div className="featured-content">
            ...
            <p className="project-role">
              Pet Grooming Management Platform — Final Bootcamp Project
            </p>

            <p>
              BRUVER is a full-stack web application designed for a pet grooming
              business. The platform allows clients to book appointments, manage
              services, and interact with the business through a responsive and
              user-friendly interface.
            </p>

            <p>
              Built with a separated frontend and backend architecture,
              focusing on structured API communication, data management,
              and clean modern UI design.
            </p>

            <p className="tech-stack">
              React · Node.js · JavaScript · HTML · CSS · MySQL
            </p>
          ...
          <div className="featured-image">
            <img src={Bruver} alt="Bruver Project Screenshot" />
          </div>
